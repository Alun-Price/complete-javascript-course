...
// console.log(mark.calcBMI() > john.calcBMI() ? `${mark.firstName}'s BMI (${mark.bmi}) is higher than John's(${john.bmi})` : `${john.firstName}'s BMI (${john.bmi}) is higher than Mark's(${mark.bmi})`);
...
//     };
//     return sumTotal = sum / arr.length;
// }
