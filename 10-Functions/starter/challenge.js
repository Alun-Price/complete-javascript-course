...
//   //     } else {
//   //       console.log(`${answer} is NOT an option!! Try again!!!`);
...
//     } else {
//       console.log(`Type is neither string nor array`);
//     }
//   },
// };
...
// Explanation
// Even though the function is run once, it remembers the variable environment when it was born .. So clicking afterwards on the body still brings about the color change!
